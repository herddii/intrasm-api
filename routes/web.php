...
$router->group(['prefix' => 'api' , 'middleware' => 'jwt.auth'], function() use ($router) {
    ...
    $router->group(['prefix'=>'master'],function() use($router){
        ...
        // $router->get('user',['as'=>'user','uses'=>'Master\UserController@index']);
        $router->post('user',['as'=>'userclient.view','uses'=>'Master\UserController@show']);
        $router->delete('user/{id}',['as'=>'userclient.delete','uses'=>'Master\UserController@destroy']);
    ...
    $router->group(['prefix'=>'dashboard'],function() use($router){
        Route::get('getIndex/{id_kategori}','Dashboard\DashboardController@getIndex');
        Route::get('getkategori','Dashboard\DashboardController@getkategori');
        Route::get('vers','Dashboard\DashboardController@version');
        Route::get('get-detail-article/{slug}/{id_kategori}','Dashboard\DashboardController@detail_article');
        Route::get('getfoto/{id}','Dashboard\DashboardController@getfoto');
    });
    ...
    $router->group(['prefix'=>'cam_activity'], function() use($router){
    	...
    	$router->post('list-tasklist-report', ['as'=>'list-tasklist', 'uses'=>'Cam\CamActivityController@list_tasklist_report']);
        ...
        $router->post('jumlahReport', 'Cam\CamActivityController@jumlahReport');
        $router->post('jumlahPlan', 'Cam\CamActivityController@jumlahPlan');
        $router->get('accountHandling', 'Cam\CamActivityController@accountHandling');
    });
